...
class CreateCreateItemSelectedAttributesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('create_item_selected_attributes', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('create_item_selected_attributes');
    }
}
