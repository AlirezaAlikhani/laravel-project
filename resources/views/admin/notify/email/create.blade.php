...
@section('head-tag')
    <title>صفحه ایجاد اطلاعیه ایمیل</title>
@endsection
...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12"><a href="#">اعلامیه ایمیلی</a> </li>
            <li class="breadcrumb-item font-size-12  active" aria-current="page">صفحه ایجاد اطلاعیه ایمیلی</li>
        </ol>
    </nav>
